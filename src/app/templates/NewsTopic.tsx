...
const newsItems = [
  { date: "2024.02.21", content: "最新のニュース最新のニュース最新のニュース" },
  { date: "2024.01.30", content: "2番目のニュース2番目のニュース2番目のニュース2番目のニュース2番目のニュース" },
...
export default function NewsTopic() {
  ...
  <div>
    <dl className="flex flex-col items-start w-10/12 pt-5 pb-9 mx-auto text-sm md:w-3/5 md:text-lg">
